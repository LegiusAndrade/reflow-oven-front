  ...
  return (
    <div ref={triggerRef} className={clsx("relative", className)}>
      <button
        ...
        aria-expanded={open}
        aria-label={label}
        className='btn-press flex w-full items-center gap-2 rounded-xl border border-white/15 px-3 py-2.5'
      >
      ...
      {open &&
        createPortal(
          <div
            ...
            className='card text-fg z-[80] rounded-xl border border-white/10 p-2 shadow-xl'
          >
            <DayPicker
              mode='single'
              locale={ptBR}
